...
|---|---|
| true만 허용 | LIVE_CONNECT_SUCCEEDED, LIVE_RESUME_SUCCEEDED, RINGING_SHOWN, FIRST_AUDIO_PLAYED, LOCATION_AVAILABLE, COMPOSER_OPENED, SOS_GUIDE_VIEWED |
| false만 허용 | PERMISSION_QUERY_UNAVAILABLE, LIVE_CONNECT_FAILED, LIVE_RESUME_FAILED, RINGING_FAILED, LOCATION_UNAVAILABLE, COMPOSER_OPEN_FAILED, SOS_GUIDE_FAILED |

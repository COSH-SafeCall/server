...
기준: **v4.2-web-mvp**. 공통 설계와 API 1~6장까지의 서버 사용·검증·운영 준비 문서다. 모든 셸 명령은 `server` 디렉터리에서 실행한다. [서버 개요 및 API 목록](../README.md)
...
| 항목 | 상태 |
|---|---|
| 인증·사용자·홈·통화·메시지·이력·삭제 | 32개 HTTP 작업 구현. A02의 시작과 콜백은 별도 작업으로 집계 |
...
| 6장 / 7장 | R01~R03 구현 / telemetry 후속 범위 |

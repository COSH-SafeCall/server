...
| 관측 O01 | 게스트·회원·온보딩, CSRF/Origin·만료·삭제 차단, 전체 허용목록·성공 의미·금지 필드, 엄격한 숫자·RFC3339, 세션별 통화 소유권, 배치/동시 중복·충돌, 배포 변경 재생, 분당 신규 120건·분 경계, DB 중간 실패 롤백, 삭제·14일 보존, OpenAPI |

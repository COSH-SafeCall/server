...
public class UserController {
	...
	@GetMapping("/profile")
	@Operation(operationId="U01",summary="U01 · 기본 정보 조회")
	...
	@Operation(operationId="U02",summary="U02 · 기본 정보 확인·수정")
	...
	@Operation(operationId="U04",summary="U04 · 브라우저 권한 상태 조회")
	public Items<PermissionView> permissions(@Parameter(hidden=true) @CookieValue(value="__Host-safecall-session",required=false) String authorization) {
		return service.permissions(authorization);
	}
	@PostMapping(value="/permissions",consumes="application/json")
	@Operation(operationId="U05",summary="U05 · 브라우저 권한 상태 저장")
	public Items<PermissionView> updatePermissions(@Parameter(hidden=true) @CookieValue(value="__Host-safecall-session",required=false) String authorization,
		@Valid @RequestBody PermissionsRequest body,@RequestHeader("Idempotency-Key") UUID key) {
		return service.updatePermissions(authorization,body,key);
	}
	@GetMapping("/emergency-contacts")
	@Operation(operationId="U07",summary="U07 · 비상 연락망 조회")
	...
	@Operation(operationId="U08",summary="U08 · 비상 연락망 등록")
	...
	@Operation(operationId="U09",summary="U09 · 비상 연락망 수정")
	...
	@Operation(operationId="U10",summary="U10 · 비상 연락망 삭제")
	...
	@GetMapping("/settings")
	@Operation(operationId="U11",summary="U11 · 사용자 설정 조회")
	...
	@Operation(operationId="U12",summary="U12 · 가상 수신 알림 방식 변경")

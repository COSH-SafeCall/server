...
public class TelemetryPolicy {
	private static final Map<String,Set<String>> CODES=Map.of(
		...
		"CALL",Set.of("LIVE_CONNECT_STARTED","LIVE_CONNECT_SUCCEEDED","LIVE_CONNECT_FAILED","RINGING_SHOWN","RINGING_FAILED","PAGE_EXITED","PAGE_RELOADED"),
	...
	private static final Set<String> SUCCESSES=Set.of("LIVE_CONNECT_SUCCEEDED","RINGING_SHOWN",
	...
	private static final Set<String> FAILURES=Set.of("PERMISSION_QUERY_UNAVAILABLE","LIVE_CONNECT_FAILED","RINGING_FAILED",
		"LOCATION_UNAVAILABLE","COMPOSER_OPEN_FAILED","SOS_GUIDE_FAILED");

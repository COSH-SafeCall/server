...
public class CallController {
	...
	@GetMapping("/{callId}")
	@Operation(operationId="C02",summary="C02 · 통화 조회")
	...
	@Operation(operationId="C03",summary="C03 · Gemini 단기 연결 정보",description="발급 중 202, 준비 완료 200. 조회로 토큰을 새로 발급하지 않습니다. 반환된 토큰은 현재 페이지 메모리에서만 사용합니다.")
	...
	@Operation(operationId="C04",summary="C04 · 통화 사건 기록",description="CONNECTED → RINGING_SHOWN → ANSWERED 순서. FAILED에만 errorCode가 필수입니다. 동일 사건 재시도는 현재 통화 상태를 반환합니다.")
	...
	@Operation(operationId="C05",summary="C05 · 통화 생존 신호",description="본문 {}. 5초 간격, 30초 lease 만료 시 종료. 통화 상한과 version을 연장하지 않습니다.")

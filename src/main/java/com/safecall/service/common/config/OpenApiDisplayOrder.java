...
final class OpenApiDisplayOrder {
	...
	private static final List<Group> GROUPS = List.of(
		...
		new Group("08. 안심 메시지", "체험 문자는 TEST, 일반 안심 문자는 SAFETY를 사용합니다. 실제 SMS 발송 API가 아닙니다.", List.of("M01")),
		new Group("09. AI 안심 통화", "생성 직후 C05를 5초마다 유지하며 C03을 조회합니다. 실제 음성에는 Live 클라이언트가 필요합니다.", List.of("C01", "C02", "C03", "C04", "C05", "C06")),
